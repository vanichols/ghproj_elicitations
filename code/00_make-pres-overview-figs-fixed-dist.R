...
f1 <- 
  p2 %>%
  filter(package_title != "Frog warts") %>% 
  mutate(package_title = ifelse(package_title == "Troll manure", 
                                "Package #1", 
                                "Package #2")) %>% 
...
ggsave("figs/fig_example-2-packages-all-fixed.png", width = 6, height = 4)
...
ggsave("figs/fig_example-2-packages-fixed.png", width = 10, height = 6)
